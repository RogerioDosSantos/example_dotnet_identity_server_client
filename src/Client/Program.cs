...
namespace Client
{
    public class Program
    {
        private static async Task Main()
        {
            ...
            var disco = await client.GetDiscoveryDocumentAsync("http://localhost:5000"); //URL of the IdentityServer
            if (disco.IsError)
            {
            ...
            try
            {
                var response = await apiClient.GetAsync("http://localhost:5001/identity"); //API address
